<?php
	...
	class Telefonia extends Controlador {
		...
		public function Index() {
            ...
            $Val->Requerido('marcacion', 'Debe informar la primera Marcación');
            $Val->Requerido('CM1', 'Debe ingresar una referencia Cable Módem');
            $Val->Requerido('SS1', 'Debe ingresar una referencia SoftSwich');
